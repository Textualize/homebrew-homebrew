class Toolong < Formula
  ...
  desc "A terminal application to view, tail, merge, and search log files (plus JSONL)"
  homepage "https://github.com/textualize/toolong"
  url "https://files.pythonhosted.org/packages/1a/63/896be4418f18fb0354d712735bef21e4660f8885efdd7440945ca02c9085/toolong-1.4.0.tar.gz"
